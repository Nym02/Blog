        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                if (isset($_POST['search'])) {
                    ...
                    $blogPost             = "SELECT * FROM post where title LIKE '%$searchPost%' OR description LIKE '%$searchPost%' ";
                    $blogPostSql          = mysqli_query($db, $blogPost);
                    $totalBlogPost        = mysqli_num_rows($blogPostSql);


                    if ($totalBlogPost == 0) {
                        echo '<div class="alert alert-warning">Sorry!!!! Coudn\'t find any post.</div>';
                    } else {
