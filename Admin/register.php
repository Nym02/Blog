        ...
        <div class="card-body register-card-body">
            ...
            <form action="" method="post">
                ...
                <div class="row">
                    ...
                    <!-- /.col -->
                    <div class="col-4">
                        <button type="submit" name="registerAdminUser" class="btn btn-primary btn-block">Register
                        </button>
                    </div>
                    <!-- /.col -->
                </div>
            ...
            if (isset($_POST['registerAdminUser'])) {
                ...
                if($password == $rePassword){
                    ...
                    $registerUser = "INSERT INTO users(full_name, username, email, password, role, status, join_date) VALUES ('$full_name','$username', '$email', '$hashedPass', 2, 0, now())";
                    $registerUserQuery = mysqli_query($db, $registerUser);
                    ...
                    header("Location: register.php?msg=ConfirmPassDoNotMatch");
                }
