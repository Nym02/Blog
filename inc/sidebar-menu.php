...
$currUser = $_SESSION['sub_id'];

$currentUserQuery = "SELECT * from subscriber WHERE id = '$currUser'";
$sql = mysqli_query($db, $currentUserQuery);

while ($row = mysqli_fetch_array($sql)) {
$currUserFullname = $row['sub_name'];
$currUserImage = $row['sub_image'];
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <?php if (!empty($currUserImage)) { ?>
                    <img src="image/users/<?php echo $currUserImage; ?>" class="img-circle elevation-2"
                         alt="User Image">
