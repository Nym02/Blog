                    ...
                    <div class="col-md-8 m-auto">
                        <div class="card card-info card-outline">
                            ...
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered table-striped table-hover">
                                        ...
                                        while ($row  = mysqli_fetch_assoc($userSql)) {
                                            ...
                                            <tr>
                                                ...
                                                <td width="60%"><?php
                                                    if (!empty($image)) { ?>
                                                        <img src="Admin/image/sub/<?php echo $image; ?>" alt="<?php echo $full_name; ?>" width="150" style="border-radius: 50%;">

                                                    <?php } else { ?>
                                                        <img src="Admin/image/sub/p.png" alt="<?php echo $full_name; ?>" width="150" style="border-radius: 50%;">
                                ...
                                <a href="updateBlogger.php?id=<?php echo $id; ?>" class="btn btn-primary">Update Information</a>
                            </div>
                        </div>
                    </div>
                </div>
